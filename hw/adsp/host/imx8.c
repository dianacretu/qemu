/* Core IA host support for Imx8 audio DSP.
 *
...
static struct adsp_reg_space imx8_io[] = {
    { .name = "pci",
        .desc = {.base = ADSP_IMX8_PCI_BASE, .size = ADSP_PCI_SIZE},
    ...
    { .name = "mbox", .reg_count = ARRAY_SIZE(adsp_host_mbox_map),
        ...
        .desc = {.base = ADSP_IMX8_HOST_MAILBOX_BASE, .size = ADSP_MAILBOX_SIZE},
