...
static struct imx8_pci_data pdata = {0, 1, 0};
...
static void build_acpi_imx8_device(Aml *table)
{
    ...
    aml_append(crs,
    aml_memory32_fixed(ADSP_IMX8_MMIO_BASE, ADSP_MMIO_SIZE, AML_READ_ONLY));
    aml_append(crs,
    aml_memory32_fixed(ADSP_IMX8_PCI_BASE, ADSP_PCI_SIZE, AML_READ_ONLY));
